    ...
    <div className="glass-card rounded-2xl p-6 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input value={resumeUrl} onChange={e => updateSettings({ resumeUrl: e.target.value })} className="bg-background/50" />
        </div>
              ...
              <div className="glass-card rounded-2xl p-6 mb-6 animate-fade-in-up">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      value={form.techs}
                      onChange={(e) => updateProjectField('techs', e.target.value)}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateProjectField('buttonText', e.target.value)}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      value={form.imageUrl}
                      onChange={(e) => updateProjectField('imageUrl', e.target.value)}
                      placeholder="https://..."
                      className="bg-background/50 border-border/60"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-sm text-muted-foreground">Sort Order (number)</Label>
                    <Input
                      type="number"
                      value={form.sortOrder}
                      onChange={(e) => updateProjectField('sortOrder', e.target.value)}
                      className="bg-background/50 border-border/60"
                    />
                  </div>
                </div>
              ...
              {sorted.length === 0 ? (
                ...
                sorted.map((project) => (
                  <div key={project.id} className="glass-card-hover rounded-xl p-4 flex items-center gap-4">
                    ...
                    {project.imageUrl && (
                      <img src={project.imageUrl} alt={project.title} className="size-14 rounded-lg object-cover flex-shrink-0 hidden sm:block" />
                    )}
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      {project.url && (
                        <a href={project.url} target="_blank" rel="noopener noreferrer" className="size-8 rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-white/5 transition-colors">
                          <ExternalLink className="size-3.5" />
                        </a>
                      )}
                      <button onClick={() => startEdit(project)} className="size-8 rounded-lg flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-white/5 transition-colors">
                        <Pencil className="size-3.5" />
                      </button>
                      <button onClick={() => handleDeleteProject(project.id, project.title)} className="size-8 rounded-lg flex items-center justify-center text-muted-foreground hover:text-red-400 hover:bg-white/5 transition-colors">
